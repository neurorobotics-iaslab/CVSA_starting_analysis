...
% create the dataset log band power, selected channels and freq 8-14
...
sampleRate = 512;
sfile = ['/home/paolo/cvsa_ws/record/' c_subject '/dataset/logband_e_cf_band_' num2str(band(1)) '' num2str(band(2)) '.mat'];
